...
void LCD_Gotoxy(unsigned char x, unsigned char y){
    ...
    switch(y){
        case 0: address = 0x80 + x; break;  // Dòng 1
        case 1: address = 0xC0 + x; break;  // Dòng 2
        case 2: address = 0x94 + x; break;  // Dòng 3
        case 3: address = 0xD4 + x; break;  // Dòng 4
        default: address = 0x80 + x; break; // M?c d?nh v? dòng 1
    }
    delay_us(1000);
